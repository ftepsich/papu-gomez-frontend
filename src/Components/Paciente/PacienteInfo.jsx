...
class PacienteInfo extends Component {
  ...
  getFormattedAddress = (direccion) => {
    let formattedAddress = "",
      calle =
        direccion.calle !== "" && typeof direccion.calle !== "undefined"
  ...
  render() {
    return (
      <div className="card-info">
        <div className="card-header">Detalle del Paciente</div>
        <div className="card-body">
          ...
          <button type="submit" onClick={this.handleOK} className="btn">
            OK
          </button>
        </div>
      </div>
