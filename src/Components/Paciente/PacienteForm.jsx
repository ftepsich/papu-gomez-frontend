  ...
  getPacienteById = async (id) => {
    try {
      ...
      this.setState({
        ...
        fecha_nacimiento: moment(pacienteInfo.fecha_nacimiento).format(
          "DD-MM-YYYY"
        ),
  ...
  actualizarPaciente = async (event) => {
    try {
      ...
      this.setState({
        ...
        fecha_nacimiento: moment(actualizarPaciente.fecha_nacimiento).format(
          "DD-MM-YYYY"
        ),
    ...
    return (
      <div className="formulario">
        <div className="form-header">
          {this.state.isEditable ? "Editar" : "Nuevo"} Paciente
        </div>
          ...
          <div className="">
            ...
            <fieldset>
              ...
              <Select
                ...
                name="id_obra_social"
                onChange={this.handleChange}
                options={this.state.obras_sociales.map((os, key) => {
                  return {
                    value: os.id,
                    text: os.nombre,
                  };
